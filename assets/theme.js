...
var _callback, _duration, _remainingTime, _startTime, _timer, _state, _onVisibilityChangeListener, _Player_instances,
...
var PageDots = class extends HTMLElement {
    ...
    get controlledElement() {
        this._controlledElement = this._controlledElement || (this.hasAttribute("aria-controls") ? document.getElementById(this.getAttribute("aria-controls")) : null);
    ...
    _dispatchEvent(index) {
        (this.controlledElement ?? this).dispatchEvent(new CustomEvent("control:select", {
            bubbles: true,
            cancelable: true,
            detail: {index, elem: this.controlledElement}
        }));
    }
};
var PrevButton = class extends HTMLButtonElement {
    connectedCallback() {
        this._abortController = new AbortController();
        this.addEventListener("click", () => (this.controlledElement ?? this).dispatchEvent(new CustomEvent("control:prev", {
            bubbles: true,
            cancelable: true
...
var NextButton = class extends HTMLButtonElement {
    connectedCallback() {
        this._abortController = new AbortController();
        this.addEventListener("click", () => (this.controlledElement ?? this).dispatchEvent(new CustomEvent("control:next", {
            bubbles: true,
            cancelable: true
        })), {signal: this._abortController.signal});
        if (this.controlledElement) {
...
var CopyButton = class extends HTMLButtonElement {
    ...
    async _copyToClipboard() {
        ...
        timeline([
            ...
            [this.animationElement, {transform: ["translateY(0)", "translateY(-10px)"], opacity: 0}, {
                duration: 0.15,
                at: "+0.5"
            }],
...
var CustomButton = class extends HTMLButtonElement {
    ...
    constructor() {
        ...
        if (image) {
            this.appendChild(image.cloneNode(true));
            this.contentElement.removeChild(image);
            this.contentElement.classList.add("z-1");
            this.contentElement.classList.add("relative");
        }
    ...
    async attributeChangedCallback(name, oldValue, newValue) {
        if (newValue === "true") {
            ...
            animate(this.animationElement.children, {opacity: [1, 0.1]}, {
                duration: 0.35,
...
var CustomCursor = class extends HTMLElement {
    ...
    connectedCallback() {
        ...
        this.parentElement.addEventListener("pointermove", __privateMethod(this, _CustomCursor_instances, onPointerMove_fn).bind(this), {
            passive: true,
...
var _domElement, _thresholdDistance, _thresholdTime, _signal, _firstClientX, _tracking, _start, _GestureArea_instances,
    touchStart_fn, preventTouch_fn, gestureStart_fn, gestureMove_fn, gestureEnd_fn;
var GestureArea = class {
    constructor(domElement, {thresholdDistance = 80, thresholdTime = 500, signal = null} = {}) {
        ...
        __privateGet(this, _domElement).addEventListener("touchstart", __privateMethod(this, _GestureArea_instances, touchStart_fn).bind(this), {
            passive: true,
...
gestureEnd_fn = function (event) {
    ...
    const now = (/* @__PURE__ */ new Date()).getTime(), deltaTime = now - __privateGet(this, _start).time,
    ...
    if (matchedEvent) {
        __privateGet(this, _domElement).dispatchEvent(new CustomEvent(matchedEvent, {
            bubbles: true,
            composed: true,
...
var _resizeObserver, _checkPositionListener, _initialTop, _lastKnownY, _currentTop, _position, _SafeSticky_instances,
    recalculateStyles_fn, checkPosition_fn;
...
var ScrollArea = class {
    ...
    _onScroll() {
        ...
        if (direction === "start" && this._allowTriggerNearingStartEvent && scrollPosition <= this.scrollNearingThreshold) {
            this._allowTriggerNearingStartEvent = false;
            this._allowTriggerLeavingStartEvent = true;
            this._element.dispatchEvent(new CustomEvent("scroll:edge-nearing", {
                bubbles: true,
            ...
            if (this._allowTriggerLeavingStartEvent) {
                ...
                this._element.dispatchEvent(new CustomEvent("scroll:edge-leaving", {
                    bubbles: true,
                    detail: {position: "start"}
                }));
            }
...
var SplitLines = class extends HTMLElement {
    constructor() {
        ...
        new MutationObserver(__privateMethod(this, _SplitLines_instances, split_fn).bind(this, true)).observe(this, {
            characterData: true,
            attributes: false,
            childList: false,
            subtree: true
...
var BaseCarousel = class extends HTMLElement {
    connectedCallback() {
        ...
        if (this.items.length > 1) {
            ...
            this.addEventListener("control:select", (event) => this.select(event.detail.index, undefined, event.detail.elem), {signal: this._abortController.signal});
        }
    ...
    previous(animate19 = true, elem) {
        this.select(this.items.indexOf(this.previousSlide), {direction: "previous", animate: animate19}, elem);
    }

    next(animate19 = true, elem) {
        this.select(this.items.indexOf(this.nextSlide), {direction: "next", animate: animate19}, elem);
    }
...
var EffectCarousel = class extends BaseCarousel {
    ...
    _transitionTo(fromSlide, toSlide, {direction = "next", animate: animate19 = true} = {}) {
        ...
        const timelineControls = timeline3([
            ...
            [toSlide, {opacity: [0, 1], visibility: ["hidden", "visible"], zIndex: 1}, {
                at: "<",
                zIndex: {easing: "step-end"}
            }]
...
var ScrollCarousel = class extends BaseCarousel {
    ...
    select(index, {animate: animate19 = true, force = false} = {}, elem) {
        const indexBeforeChange = this.selectedIndex;
...
var CartCount = class extends HTMLElement {
    ...
    set itemCount(count) {
        ...
        if (count === 0) {
            ...
            (async () => {
                await animate3(this.shadowRoot.firstElementChild, {
                    transform: ["translateY(-50%)"],
                    opacity: 0
                }, {duration: 0.25, easing: [1, 0, 0, 1]}).finished;
                this.innerText = count;
                animate3(this.shadowRoot.firstElementChild, {
...
var Drawer = class extends DialogElement {
    ...
    _showTransition(animate19 = true) {
        ...
        if (reduceDrawerAnimation) {
            animationControls = motionAnimate(this, {
                opacity: [0, 1],
...
var Popover = class extends DialogElement {
    ...
    _showTransition(animate19 = true) {
        ...
        if (window.matchMedia("screen and (max-width: 999px)").matches) {
            ...
            animationControls = motionTimeline2([
                [this, {opacity: [0, 1], visibility: ["hidden", "visible"]}, {duration: 0.15}],
                [content, {clipPath: ["inset(100% 0 0 0 round 8px)", "inset(0 0 0 0 round 8px"]}, {
                    duration: 0.4,
                    easing: [0.86, 0, 0.07, 1]
                }],
                [content.children, {opacity: [0, 1]}, {duration: 0.15}],
    ...
    _hideTransition() {
        ...
        if (window.matchMedia("screen and (max-width: 999px)").matches) {
            ...
            animationControls = motionAnimate2(this, {
                opacity: [null, 0],
                visibility: ["visible", "hidden"]
            }, {duration: 0.15});
        }
...
var CartDrawer = class extends Drawer {
    ...
    async _onCartChanged(event) {
        ...
        if (event.detail.cart["item_count"] > 0) {
            ...
            animate4(this.querySelector(".empty-state"), {
                opacity: [0, 1],
...
var LineItem = class extends HTMLElement {
    ...
    async _onChanged(event) {
        ...
        await animate4(this, {
            ...
            overflow: "hidden",
            opacity: [1, 0]
        }, {duration: 0.2, easing: "ease"}).finished;
        this.remove();
    }
};
...
var PillLoader = class extends HTMLElement {
    ...
    attributeChangedCallback(name, oldValue, newValue) {
        if (newValue === "true") {
            ...
            animate6(this.firstElementChild.querySelectorAll("span"), {opacity: [1, 0.1]}, {
                duration: 0.35,
...
function createMediaImg(media, widths = [], properties = {}) {
    const image = new Image(media["preview_image"]["width"], media["preview_image"]["height"]),
        src = media["preview_image"]["src"], featuredMediaUrl = new URL(src.startsWith("//") ? `https:${src}` : src);
...
var _recipientCheckbox, _recipientOtherProperties, _recipientSendOnProperty, _offsetProperty, _recipientFieldsContainer,
    _GiftCardRecipient_instances, synchronizeProperties_fn, formatDate_fn;
...
var ProductCard = class extends HTMLElement {
    ...
    async _onSwatchChanged(event, target) {
        ...
        if (primaryMediaElement.src !== newPrimaryMediaElement.src) {
            ...
            await primaryMediaElement.animate({opacity: [1, 0]}, {
                duration: 150,
                easing: "ease-in",
                fill: "forwards"
            }).finished;
...
var ProductForm = class extends HTMLFormElement {
    ...
    async _onSubmit(event) {
        ...
        const response = await fetch(`${Shopify.routes.root}cart/add.js`, config);
        submitButtons.forEach((submitButton) => {
...
var MediaCarousel = class extends ScrollCarousel {
    connectedCallback() {
        ...
        this.prevElem && this.prevElem.forEach(elem => elem.addEventListener('click', () => this.previous(true, this)));
        this.nextElem && this.nextElem.forEach(elem => elem.addEventListener('click', () => this.next(true, this)));
    }

    get prevElem() {
        this._prev = this._prev || Array.from(document.querySelectorAll(this.getAttribute('prev-selector') || '.thumbnail-slide-button-prev'));
        return this._prev;
    }

    get nextElem() {
        this._next = this._next || Array.from(document.querySelectorAll(this.getAttribute('next-selector') || '.thumbnail-slide-button-next'));
        return this._next;
    }
    ...
    _onGalleryClick(event) {
        ...
        offsetX > this.clientWidth / 2 ? this.next(true, this) : this.previous(true, this);
    }
    ...
    _onButtonClicked() {
        ...
        if (media) {
            ...
            const carousel = this.closest(".product-gallery__media-list-wrapper").querySelector("media-carousel"),
                visibleImages = carousel.visibleItems.filter((item) => item.getAttribute("data-media-type") === "image");
    ...
    _onObserved(entries) {
        entries.forEach((entry) => {
            if (entry.target === this._scopeFrom) {
                this.#scopeFromPassed = !entry.isIntersecting;
            }
...
var QuickBuyDrawer = class extends Drawer {
    ...
    _onVariantAdded(event) {
        ...
        requestAnimationFrame(async () => {
            await timeline5([
                [contentShadow, {height: [`${fromHeight}px`, `${contentShadow.clientHeight}px`]}, {
                    duration: 0.35,
                    easing: [0.86, 0, 0.07, 1]
                }],
...
var _preloadedHtml, _delegate, _intersectionObserver, _form, _selectedVariant, _VariantPicker_instances,
    getActiveOptionValues_fn, getOptionValuesFromOption_fn, onOptionChanged_fn, onOptionPreload_fn, onIntersection_fn,
    renderForCombination_fn, createHashKeyForHtml_fn;
...
var VideoMedia = class extends BaseMedia {
    connectedCallback() {
        super.connectedCallback();
        if (!this.hasAttribute("autoplay")) {
            this.addEventListener("click", this.play, {once: this.once, signal: this._abortController.signal});
...
var PredictiveSearch = class extends HTMLElement {
    ...
    async _transitionToSlot(toSlotName) {
        ...
        return animate9(this.shadowRoot.firstElementChild.assignedNodes(), {
            opacity: [0, 1],
            transform: ["translateY(5px)", "translateY(0)"]
...
var StoreHeader = class extends HTMLElement {
    ...
    async hide() {
        if (this._isVisible) {
            $heybike.emit('header:toggle', {show: false});
            this._isVisible = false;
            document.documentElement.style.setProperty("--header-is-visible", "0");
            await animate11(this, {transform: ["translateY(0)", "translateY(-100%)"]}, {
                duration: 0.2,
                easing: "ease"
            }).finished;
    ...
    show() {
        if (!this._isVisible) {
            $heybike.emit('header:toggle', {show: true});
        ...
        if (CSS.supports("selector(:has(> *))") && this.hasAttribute("sticky") && !this.hasAttribute("hide-on-scroll") && this.hasAttribute("allow-transparency")) {
            ...
            if (this.querySelectorAll("[open]").length > 0) {
                ...
                if (this._hasSwitchedToSticky) {
                    this._hasSwitchedToSticky = false;
                    animate11(this, {transform: ["translateY(0)", "translateY(-100%)"]}, {
                        duration: 0.15,
                        easing: "ease"
                    }).finished.then(() => {
...
var DropdownDisclosure = class _DropdownDisclosure extends AnimatedDetails {
    ...
    _transitionIn(hasOpenSiblings = false) {
        ...
        if (window.matchMedia("(prefers-reduced-motion: no-preference)").matches && !reduceMenuAnimation) {
            timelineSequence.push([this.contentElement.querySelectorAll(":scope > ul > li"), {
                opacity: [0, 1],
                transform: ["translateY(-10px)", "translateY(0)"]
...
var MegaMenuDisclosure = class extends DropdownDisclosure {
    ...
    _transitionIn(hasOpenSiblings) {
        const timelineSequence = [[this.contentElement, {opacity: 1}, {duration: 0.2}], "mega-menu"],
            contentDelay = hasOpenSiblings ? 0.1 : 0;
        if (window.matchMedia("(prefers-reduced-motion: no-preference)").matches && !reduceMenuAnimation) {
            this.contentElement.querySelectorAll(".mega-menu__promo").forEach((promo) => {
                timelineSequence.push([promo, {opacity: [0, 1]}, {
                    duration: 0.25,
                    delay: contentDelay,
                    at: "mega-menu"
                }], "mega-menu-promo");
...
var NavigationDrawer = class extends Drawer {
    ...
    switchToPanel(panelIndex, linkListIndex = null) {
        ...
        let panelToHideTransform, panelToShowTransform,
            ...
            panelToShow = panels[panelIndex], linkLists = panelToShow.querySelectorAll(".panel__wrapper"),
            timelineSequence = [];
        if (document.dir === "rtl") {
        ...
        timelineSequence.push(
            [panelToHide, {
                ...
                opacity: [1, 0],
                visibility: ["visible", "hidden"]
            }, {duration: 0.3, opacity: {at: "+0.3"}, transform: {at: "+0.3"}}],
            "panelHidden",
            [panelToShow, {
                opacity: [0, 1],
                visibility: ["hidden", "visible"],
    ...
    showPanel(panelIndex, linkListIndex = null) {
        const panels = this.querySelectorAll(".panel");
        let timelineSequence = [], panelToShow = panels[panelIndex],
        ...
        if (this.previousLinkIndex && this.previousLinkIndex !== linkListIndex) {
            timelineSequence.push([linkLists[this.previousLinkIndex], {
                opacity: [1, 0],
                visibility: ["visible", "hidden"]
            }, {duration: 0.2}]);
        }
    ...
    switchLinkList(linkLists, linkListIndex) {
        ...
        return [linkLists[linkListIndex].querySelectorAll("li"), {
            opacity: [0, 1],
            visibility: ["hidden", "visible"],
            transform: ["translateY(-10px)", "translateY(0)"]
...
var ImagesWithTextScrolling = class extends HTMLElement {
    ...
    _onScroll() {
        const imageRect = this._mainImage.getBoundingClientRect(), imageBottom = imageRect.bottom,
        ...
        for (const [index, contentItem] of this._contentItems.entries()) {
            const contentItemRect = contentItem.getBoundingClientRect(),
                image = this._imageToTransitionItems[index - 1], content = this._contentItems[index];
                ...
                if (image && !image.classList.contains("is-visible")) {
                    ...
                    if (imageEffect === "fade") {
                        ...
                        timeline11([
                            ...
                            }, {duration: 0.35, easing: [0.99, 0.01, 0.5, 0.94], opacity: {duration: 0}}],
                            [content, {opacity: [null, 1]}, {duration: 0.45, at: "<"}]
                        ]);
                    }
                }
    ...
    reveal(item) {
        ...
        imageLoaded(media.querySelector("img")).then(() => {
            timeline13([
                ...
                [media.querySelector("img, video-media"), {transform: ["scale(1.05)", "scale(1)"]}, {
                    duration: 0.3,
                    at: "<"
                }]
            ]);
        });
        animate15(item.querySelector(".media-with-text__content > .prose"), {opacity: [0, 1]}, {
            duration: 0.2,
            delay: 0.3
        });
    }
...
var MultipleImagesWithTextImageList = class extends EffectCarousel {
    ...
    async _reveal() {
        ...
        if (this.getAttribute("layout") === "stacked") {
            ...
            timeline14([
                [this.children, {opacity: 1, transform: ["translateY(15px)", "translateY(0)"]}, {
                    duration: 0.3,
                    delay: stagger6(0.1)
                }]
            ]);
            ...
            timeline14([
                [this.children, {opacity: 1, transform: "rotate(var(--image-rotation, 0deg))"}, {
                    duration: 0.3,
                    delay: stagger6(0.1)
                }]
            ]);
    ...
    _transitionTo(fromSlide, toSlide, {direction, animate: animate19}) {
        ...
        if (direction === "next") {
            ...
            return timeline14([
                ...
                [fromSlide, {opacity: 1, transform: fromSlideTransform, zIndex: -1}, {
            ...
            return timeline14([
                ...
                [toSlide, {opacity: 1, transform: toSlideTransform, zIndex: 1}, {
                    duration: transitionSpeed,
...
var PressCarousel = class extends EffectCarousel {
    ...
    async _transitionTo(fromSlide, toSlide, options = {}) {
        await timeline15([
            ...
            [fromSlide.querySelector(".blockquote"), {opacity: [null, 0], ...reduceMotion2 && {transform: [null, "translateY(-10px)"]}}, {
                duration: 0.2,
                at: "<"
            }]
        ]).finished;
        ...
        await timeline15([
            ...
            [toSlide.querySelector(".blockquote"), {opacity: [0, 1], ...reduceMotion2 && {transform: ["translateY(10px)", "translateY(0px)"]}}, {
                duration: 0.2,
                at: "<"
            }]
        ]).finished;
...
var ProductRecommendations = class extends HTMLElement {
    ...
    async _loadRecommendations() {
        ...
        this._isLoaded = true;
        const section = this.closest(".shopify-section"), intent = this.getAttribute("intent") || "related",
...
var RevealedImage = class extends HTMLElement {
    connectedCallback() {
        ...
        scroll3(timeline16([
            ...
            [this.querySelectorAll("img, svg"), {transform: ["translate(-10%, -1.5%) scale(1.4)", "translate(0, 0) scale(1)"]}, {
                easing: "ease-in",
                at: "<"
            }],
...
var SlideshowCarousel = class extends EffectCarousel {
            ...
            this._player.addEventListener("player:start", (event) => {
                ...
                circles.forEach((item) => {
                    ...
                    if (item.getAttribute("aria-current") === "true") {
                        circleAnimationControl = motionAnimate4(circle, {strokeDasharray: [`0px, ${circle.getTotalLength()}px`, `${circle.getTotalLength()}px, ${circle.getTotalLength()}px`]}, {
                            duration: event.detail.duration,
                            easing: "linear"
                        });
                    } else {
                        circleAnimationControl = motionAnimate4(circle, {strokeDasharray: `${circle.getTotalLength()}px, ${circle.getTotalLength()}px`}, {
                            duration: 0,
                            easing: "linear"
                        });
                    }
    ...
    async _reveal() {
        ...
        if (!this._reloaded) {
            timeline17([
                ...
                "content",
                [selectedSlide.querySelectorAll('[data-sequence="subheading"], .button'), {opacity: [0, 1]}, {
                    duration: 0.3,
                    at: "content"
                }],
    ...
    _fade(fromSlide, toSlide) {
        return timeline17([
            [fromSlide, {opacity: [1, 0], visibility: ["visible", "hidden"], zIndex: 0}, {
                duration: 0.3,
                easing: "ease-in",
                zIndex: {easing: "step-end"}
            }],
    ...
    async _fadeWithText(fromSlide, toSlide) {
        motionAnimate4(fromSlide, {opacity: [1, 0], visibility: ["visible", "hidden"], zIndex: 0}, {
            duration: 0.3,
            easing: "ease-in",
            zIndex: {easing: "step-end"}
        });
        await imageLoaded(toSlide.querySelectorAll("img"));
        motionAnimate4(toSlide, {opacity: [0, 1], visibility: ["hidden", "visible"], zIndex: 1}, {
            duration: 0,
            zIndex: {easing: "step-end"}
        });
        return timeline17([
            ...
            "content",
            [toSlide.querySelectorAll('[data-sequence="subheading"], .button'), {opacity: [0, 1]}, {
                duration: 0.3,
                at: "content"
            }],
...
customElements.define("countdown-timer", class extends HTMLElement {
    ...
    connectedCallback() {
        this.MILLISECONDS_SECOND = 1000;
        this.MILLISECONDS_MINUTE = 60 * this.MILLISECONDS_SECOND;
        this.MILLISECONDS_HOUR = 60 * this.MILLISECONDS_MINUTE;
        this.MILLISECONDS_DAY = 24 * this.MILLISECONDS_HOUR;
    ...
    get cycleDuration() {
        return (this.getAttribute('cycle-duration') || 0) * 24 * 60 * 60 * 1000;
    }
    ...
    formatTime(count) {
        const days = Math.max(0, Math.floor(count / this.MILLISECONDS_DAY));
    ...
    startCycleTimer(startNow, timeOffset, cycleDuration) {
        const timeout = setInterval(() => {
            const now = Date.now() + timeOffset;
            // 计算从初始时间到当前时间的差值
            const elapsedTime = now - startNow;
            // 计算当前周期剩余的时间
...
customElements.define('scroll-area', class extends HTMLElement {
    ...
    onInit = () => {
        ...
        this._node.addEventListener('scroll', (ev) => {
            ...
            const moveY = (top / this.scrollTotalHeight) * this.barTotalHeight;
...
customElements.define('hey-popup', class extends HTMLElement {
    ...
    get selector() {
        return this.hasAttribute('data-selector') ? this.getAttribute('data-selector') : '.m-popup';
    }
...
class LazyImage extends HTMLImageElement {
    ...
    connectedCallback() {
        if (this.hasAttribute('data-srcset') || null !== this.media) {
            if (!window._h_) {
                window._h_ = new IntersectionObserver(
                    (entries) => {
                        entries.forEach((entry) => {
                            if (entry.isIntersecting) {
                                const elem = entry.target;
                                if (elem.hasAttribute('data-srcset')) {
                                    elem.handleLazy.call(elem);
                                } else {
                                    (elem.hasAttribute('src') || elem.hasAttribute('srcset')) && elem.mediaLazy.call(elem);
                                }
                                window._h_.unobserve(elem);
                            }
                        });
                    },
    ...
    mediaLazy() {
        ...
        (this.media.classList.add(this.selecter),
    ...
    handleLazy(elem) {
        if (!elem.classList.contains('loaded')) {
            ...
            for (let i = 0; i < len; i++) {
                const srcset = srcsetList[i].trim();
                const cur = srcset.split(' ');
                const cw = parseInt(cur[1].trim());
                if (i === 0 && width < cw) {
                    elem.src = cur[0].trim();
                    break;
                } else if (i === len - 1 && width > cw) {
                    elem.src = cur[0].trim();
                    break;
                }
                const next = srcsetList[Math.min(i + 1, len - 1)].trim().split(' ');
                const nw = parseInt(next[1].trim());
                if (width >= cw && width <= nw) {
                    elem.src = next[0].trim();
                    break;
                }
            }
            this.mediaLazy.call(this);
        }
    }
}
...
class Animation {
    ...
    beforeLoad() {
        ...
        switch (this.type) {
            case 'fade-in':
                animate(this.container, {opacity: 0}, {duration: 0});
                break;
            ...
            case 'fade-up-large':
                animate(this.container, {transform: 'translateY(90%)', opacity: 0}, {duration: 0});
                break;

            case 'zoom-out':
                animate(this.container, {transform: 'scale(1.3)'}, {duration: 0});
                break;
        }
    }
    ...
    async load() {
        ...
        switch (this.type) {
            ...
            case 'fade-up':
                await animate(this.container, {transform: 'translateY(0)', opacity: 1}, {
                    duration: 1.5,
                    delay: this.delay,
                    easing: [0.16, 1, 0.3, 1]
                }).finished;
            ...
            case 'zoom-out':
                await animate(this.container, {transform: 'scale(1)'}, {
                    duration: 1.3,
                    delay: this.delay,
                    easing: [0.16, 1, 0.3, 1]
                }).finished;
    ...
    async reset(duration) {
        ...
        switch (this.type) {
            ...
            case 'zoom-out':
                await animate(this.container, {transform: 'scale(0)'}, {
...
customElements.define("checkout-button", class extends HTMLElement {
    ...
    connectedCallback() {
        this.button?.addEventListener('click', this.onCheckout.bind(this));
    }

    get button() {
        this._button = this._button || this.querySelector('.button[type="button"]');
        return this._button;
    }
    ...
    onCheckout() {
        ...
        let allFormData = {items: [], button: this.button};
        const checkedBundles = document.querySelectorAll(".bundled_sale input[name='bundles']:checked:not(.unsubmit)");
        if (checkedBundles && checkedBundles.length > 0) {
            checkedBundles.forEach((item) => {
                const parentDiv = item.closest('.bundle-item');
